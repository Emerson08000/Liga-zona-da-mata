        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-green-200">
              <li><Link to="/sobre" className="hover:text-white transition-colors">Sobre a LZMF</Link></li>
              <li><a href="#" className="hover:text-white transition-colors">Regulamento</a></li>
              <li><Link to="/times-filiados" className="hover:text-white transition-colors">Times Filiados</Link></li>
              <li><Link to="/historia" className="hover:text-white transition-colors">História</Link></li>
            </ul>
          </div>
          <div>
